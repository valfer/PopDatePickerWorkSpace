...
public class PopDatePicker : NSObject, UIPopoverPresentationControllerDelegate, DataPickerViewControllerDelegate {
    ...
    public init(forTextField: UITextField) {
        ...
        //datePickerVC = UIStoryboard(name:"DataPickerViewController", bundle:nil).instantiateViewControllerWithIdentifier("datePickerVC") as PopDatePickerViewController
